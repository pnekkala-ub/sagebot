...
class DialogManager:
    def __init__(self, ):
        ...
        self.ner_tokenizer =  AutoTokenizer.from_pretrained("sentientconch/retrained_ner", use_auth_token='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')
        ...
        self.ner_pipeline = pipeline("ner", model="sentientconch/retrained_ner",aggregation_strategy="first", use_auth_token='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')
